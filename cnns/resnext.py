...
class ResNeXt:
    def __init__(self, number_of_classes, model_type="resnext50_32x4d"):
        ...
        # 1. Loading pre-trained ResNeXt model from torchvision
        ...
        # 2. Modifying the classifier to match the number of classes
    ...
    def fit(self, path_to_dataset, 
        ...
        # 1. Defining data transforms for ResNeXt architecture.
        transform = torchvision.transforms.Compose([
            torchvision.transforms.Resize((224, 224)),  # ResNeXt typically uses 224x224 images
